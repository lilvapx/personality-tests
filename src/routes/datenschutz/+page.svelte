...
<p class="muted">Stand: 23. August 2026</p>
...
<p>
	Diese Website wird gehostet bei <strong>Cloudflare, Inc.</strong> (101 Townsend St, San Francisco, CA 94107, USA)
	über den Dienst <em>Cloudflare Pages</em>. Beim Aufruf der Website verarbeitet Cloudflare technisch notwendige
...
<p>
	...
	Es findet <strong>keine Übertragung an einen Server</strong> statt. Du kannst deine Ergebnisse optional selbst
...
<style>
	...
	.muted { color: #777; }
	.small { font-size: 0.8rem; margin-top: 2.5rem; }
	a { color: #4a90d9; }
</style>
